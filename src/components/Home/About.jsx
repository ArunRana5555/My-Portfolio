            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">Arun Kumar </span>
                 and I'm from <span className="yellow"> Saharanpur , Uttar Pradesh, India</span>
                <br />
                <br />
                I graduated with a Master's degree in Computer Science and Engineering in 2024.
                <br />
                <br />
                  As a
              ...
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  <li className="social-icons">
                    <a
                      href="https://github.com/ArunRana5555"
                      target="_blank"
                      rel="noreferrer"
